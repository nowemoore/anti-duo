...
// so this awaits `getSupabase()` where the phone's copy reads a module-level client. Everything else
// is the phone's file verbatim — the two write the same columns, or the table means two things.
